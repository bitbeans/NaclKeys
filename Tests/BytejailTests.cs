...
namespace Tests
{
    ...
    public class BytejailTests
    {
        ...
        {
            const string expected = "MYhv6q2iGDu1U2r4FVYzDh5HrbsWdhFdxVj5iGxXPBm4a3oyP1";
        ...
        {
            const string expected = "MQSmHDY9Tfy3V36n9agbw8BwvnnS9t6FSHnSJFdWiVJ2LzPCUb";
        ...
        public void DecodeBytejailIdTest()
        {
            ...
            var publicKey = KeyGenerator.DecodeBytejailPublicKey("MYhv6q2iGDu1U2r4FVYzDh5HrbsWdhFdxVj5iGxXPBm4a3oyP1");
