...
namespace Tests
{
    ...
    public class BytejailTests
    {
        ...
        {
            const string expected = "2PonPHk28TBvBu3iADjXZAH5gPh8fTpQ2mh4eMbkLhPnMrAywsq";
        ...
        {
            const string expected = "2PfXEU8XZedzDv3xt7pfAsiCLTt3az1EeFV7zwaRL2hKKd7ZAyR";
        ...
        public void DecodeBytejailIdTest()
        {
            ...
            var publicKey = KeyGenerator.DecodeBytejailPublicKey("2PonPHk28TBvBu3iADjXZAH5gPh8fTpQ2mh4eMbkLhPnMrAywsq");
